    ...
    <div className="app">
      ...
      <header className="app-header">
          ...
          <div className="header-left">
            <div className="logo">
              ...
              <div>
                ...
                <p className="app-sub">Thực đơn hàng ngày cho người bệnh thận mạn tính</p>
              </div>
            </div>
          </div>
        ...
        <div className="health-banner">
          <IconHeart />
          <span>Tất cả món ăn được chọn lọc phù hợp bệnh thận mạn tính: <strong>ít kali · ít phốt-pho · ít natri · đạm vừa phải</strong>. Vui lòng tham khảo bác sĩ dinh dưỡng.</span>
        </div>
      </header>
